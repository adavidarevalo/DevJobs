const Elements = [
  {
    id: 1,
    company: 'Scoot',
    logo: require('@/assets/logos/scoot.svg'),
  ...
  },
  {
    id: 2,
    company: 'Blogr',
    logo: require('@/assets/logos/blogr.svg'),
  ...
  },
  {
    id: 3,
    company: 'Vector',
    logo: require('@/assets/logos/vector.svg'),
  ...
  },
  {
    id: 4,
    company: 'Office Lite',
    logo: require('@/assets/logos/officelite.svg'),
  ...
  },
  {
    id: 5,
    company: 'Pod',
    logo: require('@/assets/logos/pod.svg'),
  ...
  },
  {
    id: 6,
    company: 'Creative',
    logo: require('@/assets/logos/creative.svg'),
  ...
  },
  {
    id: 7,
    company: 'Pomodoro',
    logo: require('@/assets/logos/pomodoro.svg'),
  ...
  },
  {
    id: 8,
    company: 'Maker',
    logo: require('@/assets/logos/maker.svg'),
    ...
    requirements: {
      ...
      items: [
        'Comuter Science degree or equivalent',
  ...
  },
  {
    ...
    logo: require('@/assets/logos/coffeeroasters.svg'),
  ...
  },
  {
    id: 10,
    company: 'Mastercraft',
    logo: require('@/assets/logos/mastercraft.svg'),
    ...
    requirements: {
      ...
      items: [
        'At east 3 years of experience in a related field.',
  ...
  },
  {
    id: 11,
    company: 'Crowdfund',
    logo: require('@/assets/logos/crowdfund.svg'),
    ...
    requirements: {
      content: 'We had love to hear from you if you take ownership of your work and continuously want to improve the products you have built. We are looking for developers who have an uncanny abilithy to work very well cross-functionality in a flat startup.',
      items: [
  ...
  },
  {
    id: 12,
    company: 'Typemaster',
    logo: require('@/assets/logos/typemaster.svg'),
  ...
  },
  {
    ...
    role: {
      content: 'In this role, you are part of our Product team comprised of Frontend & Backend Developers, UX & UI Specialists and Product Owners. You will work on mission critical projects from the first day on, support other engineers, share your knowledge with your colleagues, and contribute to agile projects.',
      items: [
...
export const SearchElement = (id = false) => {
  if (!id) {
    return Elements;
  }
  return Elements.filter((item) => item.id === Number(id));
};

export const SearchFilter = (name = '', location = '', Time) => {
  console.log('buscando', name)
  console.log('location ', location)
  console.log('Time ', Time)
  let ElementsFilter = Elements;
  if (name !== '') {
    ElementsFilter = ElementsFilter.filter((item) => (item.position.toLowerCase().includes(name) ? item : null));
  }
  if (location !== '') {
    ElementsFilter = ElementsFilter.filter((item) => (item.location.toLowerCase().includes(location) ? item : null));
  }
  if (Time) {
    ElementsFilter = ElementsFilter.filter((item) => (item.contract === 'Full Time' ? item : null));
  }
  console.log('XXX ', ElementsFilter)
